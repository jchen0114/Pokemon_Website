...
class Pokemon(models.Model):
    ...
    image = models.ImageField(upload_to='profile_image',default=u'image/default.png',max_length=100)
    ...
    evolve_tool = models.ImageField(upload_to='evolve_tools',default=u'image/default.png',blank=True)
    summary = models.TextField(max_length=500, blank=True)
    weakness = models.ManyToManyField(Type, related_name='weakness')
    evolve_img = models.ImageField(upload_to='evolve_images',default=u'image/default.png',blank=True)
...
class Movie(models.Model):
    ...
    image = models.ImageField(upload_to='movies',max_length=100)
